-- Dockmaster: this file captures deployed NHCSO behavior without invoking promotion or replaying data.
-- It is schema/function baseline only; promote_nhcso_class remains service-role-only and is not called here.
