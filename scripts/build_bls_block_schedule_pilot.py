...
def css() -> str:
    ...
    * { box-sizing: border-box; }
    ...
    .day-timeline {
      ...
      border: 1px solid rgba(24,33,44,.12);
    }
    .day-timeline-segment {
      min-width: 0;
      background: transparent;
      border-right: 1px solid rgba(24,33,44,.16);
    }
    .day-timeline-segment:last-child { border-right: 0; }
    .day-timeline-segment.is-offered { background: #ffe67a; }
