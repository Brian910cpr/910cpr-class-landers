...
<div class="wrap">
  <div class="page-shell">
    <main class="card home-shell">
      ...
      <section class="home-jumps home-course-jumps" aria-label="Jump to course categories">
        <a class="course-jump-card" href="#bls">
          <img src="/images/25-bls-new.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>Basic Life Support (BLS)</strong>
          <span>Healthcare provider CPR, AED, and team-response training.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card" href="#acls">
          <img src="/images/25-acls-new.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>Advanced Cardiovascular Life Support (ACLS)</strong>
          <span>Advanced adult cardiac arrest, rhythms, and team care.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card" href="#pals">
          <img src="/images/25-pals-new.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>Pediatric Advanced Life Support (PALS)</strong>
          <span>Pediatric emergency assessment, resuscitation, and rhythms.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card" href="#heartsaver">
          <img src="/images/25_Heartsaver.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>HeartSaver</strong>
          <span>Workplace CPR/AED and first aid options for non-healthcare needs.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card course-jump-card-logo" href="#arc">
          <img src="/images/0arc.png" alt="" loading="lazy">
          <span class="course-jump-kicker">Red Cross</span>
          <strong>American Red Cross (ARC)</strong>
          <span>ARC BLS, CPR/AED, and First Aid/CPR/AED certification paths.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card course-jump-card-logo" href="#hsi">
          <img src="/images/0hsi.png" alt="" loading="lazy">
          <span class="course-jump-kicker">HSI</span>
          <strong>Health &amp; Safety Institute (HSI)</strong>
          <span>Workplace-friendly BLS, CPR/AED, and first aid training.</span>
          <b>View course options</b>
        </a>
      </section>
