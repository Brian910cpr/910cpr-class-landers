...
<div class="wrap">
  <div class="page-shell">
    <main class="card home-shell">
      ...
      <section class="home-jumps home-course-jumps home-index-course-jumps" aria-label="Jump to course categories">
        <a class="course-jump-card home-index-course-card" href="#bls">
          <img src="/images/25-bls-new.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>BLS</strong>
          <span>Healthcare provider CPR, AED, and team response.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card home-index-course-card" href="#acls">
          <img src="/images/25-acls-new.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>ACLS</strong>
          <span>Advanced cardiac arrest, rhythms, and team care.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card home-index-course-card" href="#pals">
          <img src="/images/25-pals-new.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>PALS</strong>
          <span>Pediatric assessment, resuscitation, and rhythms.</span>
          <b>View course options</b>
        </a>
        <a class="course-jump-card home-index-course-card" href="#heartsaver">
          <img src="/images/25_Heartsaver.png" alt="" loading="lazy">
          <span class="course-jump-kicker">AHA</span>
          <strong>HeartSaver</strong>
          <span>Workplace CPR/AED and First Aid options.</span>
          <b>View course options</b>
        </a>
