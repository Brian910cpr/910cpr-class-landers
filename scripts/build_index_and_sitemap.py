...
<div class="wrap">
  <div class="page-shell">
    <main class="card home-shell">
      ...
      <section class="home-jumps home-cert-jumps" aria-label="Certification quick links">
        <div class="home-cert-group" aria-label="American Heart Association classes">
          <span class="home-cert-label">AHA</span>
          <a class="jump-chip cert-jump-chip" href="#bls">(BLS)</a>
          <a class="jump-chip cert-jump-chip" href="#acls">(ACLS)</a>
          <a class="jump-chip cert-jump-chip" href="#pals">(PALS)</a>
          <a class="jump-chip cert-jump-chip" href="#heartsaver">(HeartSaver)</a>
        </div>
        <div class="home-cert-group home-cert-group-secondary" aria-label="Red Cross and HSI classes">
          <a class="jump-chip cert-jump-chip" href="#arc">(ARC)</a>
          <a class="jump-chip cert-jump-chip" href="#hsi">(HSI)</a>
        </div>
      </section>
