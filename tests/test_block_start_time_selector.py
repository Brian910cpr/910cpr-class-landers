...
class BlockStartTimeSelectorTests(unittest.TestCase):
    ...
    def test_rendered_html_has_register_links_but_not_block_class_label(self):
        ...
        self.assertIn("function deliveryFromDeepLink()", html)
        self.assertIn("function showAllFromDeepLink()", html)
        self.assertIn('name="delivery-filter"', html)
        self.assertIn("Delivery type", html)
        self.assertIn('value="online-skills"> Online + Skills', html)
        self.assertIn("function publicDeliveryBucket", html)
        self.assertIn("'blended'", html)
        self.assertIn("'heartcode'", html)
        self.assertIn("'skills-session'", html)
    ...
    def test_config_driven_heartsaver_page_generates_valid_schedule(self):
        ...
        self.assertIn("selectedDelivery = deliveryFromDeepLink()", html)
        self.assertIn("showAllOptions = showAllFromDeepLink()", html)
        self.assertIn("No matching times are currently available. Try All delivery types.", html)
